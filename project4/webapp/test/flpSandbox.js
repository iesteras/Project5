		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sapui5 mtar app",
									"targetURL": "#devnttdatacomproject4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"devnttdatacomproject4-display": {
								"semanticObject": "devnttdatacomproject4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dev.nttdata.com.project4",
									"url": sap.ui.require.toUrl("dev/nttdata/com/project4")
								}
							}
						}
					}
